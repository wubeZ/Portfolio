    ...
    <main id="contact" className="mt-24 pt-24 pb-16 px-4">
      ...
      <div className="mx-auto max-w-4xl mt-12 px-8 bg-[#2b394d4c]">
        <form className="flex flex-col gap-4 py-8" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className={` bg-[#3652f1a5] ${isSending ? "opacity-50 cursor-not-allowed": ""}  hover:bg-[#10d1ef55] transition-colors duration-200 sm:mx-auto text-white font-secondary rounded-md px-4 sm:px-12 py-2`}
          >
